...
export default function OmegaDTPrintPageClient({ ticket }: { ticket: Ticket }) {
  ...
  return (
    <>
      ...
      <div className="no-print fixed top-0 left-0 right-0 z-50 bg-slate-900 text-white px-6 py-3 flex items-center justify-between shadow-xl">
        ...
        <button
          onClick={handlePrint}
          className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2 rounded-xl font-semibold transition-colors shadow-lg shadow-emerald-900/30"
        >
      ...
      <div className="no-print-padding pt-16">
        ...
        >
          ...
          <div className="mt-8 pt-4 border-t border-slate-200 flex justify-between items-center text-xs text-slate-400">
            ...
            <p>This document is system-generated and valid without signature for internal use.</p>
          </div>
        </div>
      </div>
